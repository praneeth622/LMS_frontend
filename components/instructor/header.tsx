              ...
              <div className="p-4">
                ...
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-muted border border-border">
                    <p className="text-sm font-semibold text-foreground">New student enrolled</p>
                    <p className="text-xs text-muted-foreground mt-1">Sarah joined your React course</p>
                  </div>
                  <div className="p-3 rounded-lg bg-muted border border-border">
                    <p className="text-sm font-semibold text-foreground">Course review submitted</p>
                    <p className="text-xs text-muted-foreground mt-1">5-star review for JavaScript Basics</p>
                  </div>
                </div>
              </div>
