...
export function AdminSidebar({ collapsed, onToggle }: AdminSidebarProps) {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          <AnimatePresence mode="wait">
            {isExpanded ? (
              ...
              >
                <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center shadow-md border border-primary/20">
      ...
      {/* Navigation */}
      <nav 
        className="flex-1 p-3 space-y-1 overflow-hidden scrollbar-hide"
      >
        {navigation.map((item) => {
