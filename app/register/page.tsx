...
import { signUp, getAllRoles, Role } from "@/lib/auth"
  ...
  React.useEffect(() => {
    const fetchRoles = async () => {
      try {
        ...
        console.warn("Failed to fetch roles from API, using fallback roles")
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-secondary/10 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <Link 
            href="/"
            className="inline-flex items-center space-x-2 text-muted-foreground hover:text-primary transition-colors duration-200 mb-8"
          >
